...
public class RestTemplateService {
	...
	public ResponseEntity<MemberDto> postWithParamAndBody() {
		URI uri = UriComponentsBuilder
				...
				.queryParam("organization", "does")
				.encode()
				.build()
				.toUri();

		MemberDto memberDto = new MemberDto();
		memberDto.setName("jy");
		memberDto.setEmail("jy@does.kr");
		memberDto.setOrganization("dose interactive");
	...
	public ResponseEntity<MemberDto> postWithHeader() {
		...
		MemberDto memberDto = new MemberDto();
		memberDto.setName("doesdoes");
		memberDto.setEmail("dddd@does.kr");
		memberDto.setOrganization("seod");
